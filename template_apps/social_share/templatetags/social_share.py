# Taken from django-social-share
...
@register.inclusion_tag('social_share/templatetags/send_email.html', takes_context=True)
...
@register.inclusion_tag('social_share/templatetags/post_to_linkedin.html', takes_context=True)
...
@register.inclusion_tag('social_share/templatetags/post_to_reddit.html', takes_context=True)
...
@register.inclusion_tag('social_share/templatetags/post_to_telegram.html', takes_context=True)
